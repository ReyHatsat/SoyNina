...
// if unable to update the equipo, tell the user
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "No se puede actualizar el equipo","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "No se puede actualizar el equipo. Los datos están incompletos.","document"=> ""));
}
?>
