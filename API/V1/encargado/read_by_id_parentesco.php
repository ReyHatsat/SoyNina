...
$encargado->id_parentesco = isset($_GET['id_parentesco']) ? $_GET['id_parentesco'] : die();
// read encargado will be here

// query encargado
$stmt = $encargado->readByid_parentesco();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $encargado_arr["total_count"]=$encargado->total_record_count();
