...
$anotacion->id_persona = isset($_GET['id_persona']) ? $_GET['id_persona'] : die();
// read anotacion will be here

// query anotacion
$stmt = $anotacion->readByid_persona();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $anotacion_arr["total_count"]=$anotacion->total_record_count();
