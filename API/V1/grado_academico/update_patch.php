...
if(!isEmpty($grado_academico->id_grado_academico)){
 
// update the grado_academico
if($grado_academico->update_patch($data)){
...
// if unable to update the grado_academico, tell the user
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update grado_academico","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update grado_academico. Data is incomplete.","document"=> ""));
}
?>
