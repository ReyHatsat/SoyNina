...
$stmt = $informacion_socioeconomica->searchByColumn($data,$orAnd);
...
if($num>0){
    ...
    $informacion_socioeconomica_arr["total_count"]=$informacion_socioeconomica->search_record_count($data,$orAnd);
