...
$informacion_socioeconomica->id_comparte_cuarto = isset($_GET['id_comparte_cuarto']) ? $_GET['id_comparte_cuarto'] : die();
// read informacion_socioeconomica will be here

// query informacion_socioeconomica
$stmt = $informacion_socioeconomica->readByid_comparte_cuarto();
$num = $stmt->rowCount();
