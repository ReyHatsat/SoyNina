...
$informacion_socioeconomica->id_comparte_cama = isset($_GET['id_comparte_cama']) ? $_GET['id_comparte_cama'] : die();
// read informacion_socioeconomica will be here

// query informacion_socioeconomica
$stmt = $informacion_socioeconomica->readByid_comparte_cama();
$num = $stmt->rowCount();
