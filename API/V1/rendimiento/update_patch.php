...
if(!isEmpty($rendimiento->id_rendimiento)){
 
// update the rendimiento
if($rendimiento->update_patch($data)){
...
// if unable to update the rendimiento, tell the user
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update rendimiento","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update rendimiento. Data is incomplete.","document"=> ""));
}
?>
