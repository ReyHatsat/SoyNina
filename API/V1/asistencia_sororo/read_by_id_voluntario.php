...
$asistencia_sororo->id_voluntario = isset($_GET['id_voluntario']) ? $_GET['id_voluntario'] : die();
// read asistencia_sororo will be here

// query asistencia_sororo
$stmt = $asistencia_sororo->readByid_voluntario();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $asistencia_sororo_arr["total_count"]=$asistencia_sororo->total_record_count();
