...
$transporte->activo = '';
 	...
 	$lastInsertedId=$transporte->create();
    ...
    // if unable to create the transporte, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "No se puede crear transporte","document"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "No se puede crear transporte. Los datos están incompletos.","document"=> ""));
}
?>
