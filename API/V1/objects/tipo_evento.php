...
class Tipo_Evento{
    ...
    private $conn;
    private $table_name = "tipo_evento";
	public $pageNo = 1;
...
public $activo;
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.id_evento LIKE ? OR t.tipo LIKE ?  OR t.activo LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$stmt->bindParam(3, $searchKey);
	...
	function readOne(){
		...
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.id_evento = ? LIMIT 0,1";
...
$this->activo = $row['activo'];
	...
	function create(){
		...
		$query ="INSERT INTO ".$this->table_name." SET tipo=:tipo,activo=:activo";
...
$stmt->bindParam(":activo", $this->activo);
	...
	function update(){
		...
		// update query
		$query ="UPDATE ".$this->table_name." SET tipo=:tipo,activo=:activo WHERE id_evento = :id_evento";
