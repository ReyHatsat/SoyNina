...
if(!isEmpty($registro_llamadas->id_registro)){
 
// update the registro_llamadas
if($registro_llamadas->update_patch($data)){
...
// if unable to update the registro_llamadas, tell the user
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update registro_llamadas","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update registro_llamadas. Data is incomplete.","document"=> ""));
}
?>
