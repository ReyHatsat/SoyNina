...
$informacion_academica->id_encargado_estudio = isset($_GET['id_encargado_estudio']) ? $_GET['id_encargado_estudio'] : die();
// read informacion_academica will be here

// query informacion_academica
$stmt = $informacion_academica->readByid_encargado_estudio();
$num = $stmt->rowCount();
