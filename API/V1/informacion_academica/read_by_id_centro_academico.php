...
$informacion_academica->id_centro_academico = isset($_GET['id_centro_academico']) ? $_GET['id_centro_academico'] : die();
// read informacion_academica will be here

// query informacion_academica
$stmt = $informacion_academica->readByid_centro_academico();
$num = $stmt->rowCount();
