...
$informacion_academica->id_encargado_trabajos = isset($_GET['id_encargado_trabajos']) ? $_GET['id_encargado_trabajos'] : die();
// read informacion_academica will be here

// query informacion_academica
$stmt = $informacion_academica->readByid_encargado_trabajos();
$num = $stmt->rowCount();
