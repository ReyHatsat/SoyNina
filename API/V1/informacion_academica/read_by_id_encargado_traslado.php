...
$informacion_academica->id_encargado_traslado = isset($_GET['id_encargado_traslado']) ? $_GET['id_encargado_traslado'] : die();
// read informacion_academica will be here

// query informacion_academica
$stmt = $informacion_academica->readByid_encargado_traslado();
$num = $stmt->rowCount();
