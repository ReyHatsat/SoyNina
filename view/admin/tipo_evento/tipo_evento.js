...
$("#btn_cancelar_tipo_evento").click(function(){
  $("#f_nombre_tipo_evento").val("");
});
$("#btn_agregar_tipo_evento").click(function(){
  let obj = generarObjeto()
  eventoCrear(obj);
  $("#f_nombre_tipo_evento").val("");
});
$("#f_nombre_tipo_evento").keyup(function(){/////////////cambiar/////////////
  if ($("#f_nombre_tipo_evento").val() == "") {
    $( "#btn_agregar_tipo_evento" ).prop( "disabled", true );/////////////cambiar/////////////
  }else {
    $( "#btn_agregar_tipo_evento" ).prop( "disabled", false );/////////////cambiar/////////////
  }
});
//-------------------------------->>
...
function editar(data) {
  $("#contenedor_del_modal").html(`
    ...
    `);
  let arrayID = buscarPorID(data);
  $("#f_edit").val(arrayID.tipo);/////////////cambiar/////////////
};
function activar(data) {
  ...
  $("#contenedor_del_modal").html(`
      <p class="text-danger">¿Está seguro que desea ${estado} el tipo de evento: ${arrayID.tipo}?</p>
...
function renderDataTable() {
  g__tipo_evento_datatables = $("#dt").DataTable({/////////////cambiar/////////////
    data: g__tipo_evento,/////////////cambiar/////////////
    response: true,
    destroy: true,
    columns: [/////////////cambiar/////////////
      {data: "id_evento"},
...
function eventoCrear(obj){
    fetch('API/V1/tipo_evento/create.php', {/////////////cambiar/////////////
        method:'POST',
...
function eventoEditar(data){
    ...
    fetch(`API/V1/tipo_evento/update.php?id_evento=${data}`, {/////////////cambiar/////////////
        method:'POST',
