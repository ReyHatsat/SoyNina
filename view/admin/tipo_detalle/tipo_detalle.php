    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tipo de detalle</h5>
            ...
            <div class="modal-body">
              <label class="required form-label">Nombre del nuevo tipo de detalle</label>
              <input type="text" class="form-control" id="f_nombre_tipo_detalle">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="btn_cancelar_tipo_detalle">Cancelar</button>
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" disabled id="btn_agregar_tipo_detalle"><i class="fas fa-plus"></i>Agregar nuevo tipo de detalle</button>
            </div>
        </div>
    </div>
</div>
