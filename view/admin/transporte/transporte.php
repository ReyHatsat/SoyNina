    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_1" id="btn_agregar_nuevo_campo_modal">
              <i class="fas fa-plus"></i>Agregar nuevo transporte
          </button>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <label class="form-label">Nombre del nuevo transporte</label>
              <input type="text" class="form-control" id="f_nombre_transporte">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="btn_cancelar_transporte">Cancelar</button>
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" disabled id="btn_agregar_transporte"><i class="fas fa-plus"></i>Agregar nuevo transporte</button>
            </div>
        </div>
    </div>
</div>
