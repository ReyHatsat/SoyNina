...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
		...
		<div class="d-flex flex-column flex-root">
				...
				<div id="kt_aside" class="aside aside-extended bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
							<a href="">
								<img alt="Logo" src="<?=PATH_VIEW?>assets/media/logos/soy_nina_logo.svg" class="h-30px" />
							</a>
						</div>
						<!--end::Logo-->
						<!--begin::Nav-->
						<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
								...
								<ul class="nav flex-column">
									<!--begin::Nav item-->
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Panel Administrativo">
										<!--begin::Nav link-->
            ...
            <?php _adminComponent('footer'); ?>
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade active show" id="kt_aside_nav_tab_projects" role="tabpanel">
											...
											<div class="m-0">
												...
												<div class="m-0">
													<!--begin::Heading-->
													<h1 class="text-gray-800 fw-bold mb-6 mx-5">Panel administrativo</h1>
													<!--end::Heading-->
													<!--begin::Items-->
                          <!--begin::Menu-->
                              ...
                              <div class="menu-item">
    													...
    													<div class="menu-item">
    														<div class="menu-content pt-0 pb-2">
    															<span class="menu-section text-muted text-uppercase fs-8 ls-1">Manejo de personas</span>
    														</div>
    														<a class="menu-link" href="?adm=persona">
    															<span class="menu-icon">
    																<i class="fas fa-user-cog"></i>
    																</span>
    															</span>
    															<span class="menu-title">Lista de personas</span>
    														</a>
    													</div>
                              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                  ...
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=nina">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Lista de niñas</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=informacion_personal">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Informacion Personal</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=informacion_psicosocial">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Informacion Psicosocial</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=grados_repetidos">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Grados repetidos</span>
                                    </a>
                                  </div>
    														</div>
    													</div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=persona_relacionada">
                                  <span class="menu-icon">
                                    <i class="fas fa-people-arrows"></i>
                                  </span>
                                  <span class="menu-title">Personas relacionadas</span>
                                </a>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=usuario">
                                  <span class="menu-icon">
                                  ...
                                  <span class="menu-title">Control de usuarios</span>
    													...
    													<div class="menu-item">
    														<div class="menu-content pt-8 pb-2">
    															<span class="menu-section text-muted text-uppercase fs-8 ls-1">Informacion adicional</span>
    														</div>
    													</div>
    													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    														<span class="menu-link">
    														...
    														<div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=direccion">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de direcciones</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=distrito">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de distritos</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=canton">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de cantones</span>
                                    </a>
                                  </div>
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=provincia">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de provincias</span>
                                    </a>
                                  </div>
    														</div>
  													</div>
                              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=telefono_persona">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de telefonos</span>
                                    </a>
                                  </div>
                                </div>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=telefono">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Agregar telefono</span>
                                    </a>
                                  </div>
                                </div>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=ocupacion">
                                  <span class="menu-icon">
                                  <i class="fas fa-briefcase"></i>
    															</span>
                                  <span class="menu-title">Tipos de ocupacion</span>
                                </a>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=parentezco">
                                  <span class="menu-icon">
                                    <i class="fas fa-address-book"></i>
                                  </span>
                                  <span class="menu-title">Tipos de parentezco</span>
                                </a>
                              </div>
                              ...
                              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                  ...
                                  <span class="menu-title">Vivienda</span>
                                  <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=vivienda">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Informacion de vivienda</span>
                                    </a>
                                  </div>
                                </div>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=convivencia">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Convivencia</span>
                                    </a>
                                  </div>
                                </div>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=medio_transporte">
                                  <span class="menu-icon">
                                    <i class="fas fa-bus"></i>
                                  </span>
                                  <span class="menu-title">Medios de transporte</span>
                                </a>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=grado_emergencia">
                                  <span class="menu-icon">
                                    <i class="fas fa-pump-medical"></i>
                                  </span>
                                  <span class="menu-title">Grados de emergencia</span>
                                </a>
                              </div>
                              <div class="menu-item">
                                <a class="menu-link" href="?adm=grado">
                                  <span class="menu-icon">
                                    <i class="fas fa-graduation-cap"></i>
                                  </span>
                                  <span class="menu-title">Tipos de grado</span>
                                </a>
                              </div>
                              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=club">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de clubes</span>
                                    </a>
                                  </div>
                                </div>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                  <div class="menu-item">
                                    <a class="menu-link" href="?adm=ciclo">
                                      <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                      </span>
                                      <span class="menu-title">Control de ciclos</span>
                                    </a>
                                  </div>
                                </div>
                              </div>
    													<div class="menu-item">
    														<div class="menu-content pt-8 pb-2">
    															<span class="menu-section text-muted text-uppercase fs-8 ls-1">Registros</span>
    														</div>
    													</div>
    													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    														<span class="menu-link">
    														...
    														<div class="menu-sub menu-sub-accordion">
    															<div class="menu-item">
    																<a class="menu-link" href="?adm=registro_no_comunicacion">
    																	<span class="menu-bullet">
    																		<span class="bullet bullet-dot"></span>
    																	</span>
    																	<span class="menu-title">Registro de NO comunicacion</span>
    																</a>
    															</div>
                                  <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    																<span class="menu-link">
    																	...
    																	<span class="menu-title">Registro de NO participacion</span>
    																	<span class="menu-arrow"></span>
    																</span>
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                      <div class="menu-item">
                                      <a class="menu-link" href="?adm=registro_no_participacion">
                                        <span class="menu-bullet">
                                          <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Registro</span>
    																...
    																<div class="menu-sub menu-sub-accordion menu-active-bg">
                                      <div class="menu-item">
                                      <a class="menu-link" href="?adm=registro_kit">
                                        <span class="menu-bullet">
                                          <span class="bullet bullet-dot"></span>
                                        </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                      <div class="menu-item">
                                      <a class="menu-link" href="?adm=cat_kit">
                                        <span class="menu-bullet">
                                          <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Categorias de kit</span>
                                      </a>
                                      </div>
                                    </div>
    															</div>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-0 fs-2">Panel</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-bold fs-base my-1">
									<li class="breadcrumb-item text-muted">
										<a href="index.html" class="text-muted">CRM</a>
									</li>
									<li class="breadcrumb-item text-dark"><?php _dashboardCrumb()?></li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
							...
							<div class="d-flex flex-shrink-0">
								...
								<div class="d-flex ms-3">
									<a href="controller/doLogout.php" class="btn btn-flex flex-center btn-bg-white btn-text-gray-500 btn-active-color-primary w-40px w-md-auto h-40px px-0 px-md-6 ">
										<i class="fas fa-sign-out-alt"></i>
										<span class="d-none d-md-inline">Cerrar Sesion</span>
									</a>
								</div>
								<!--end::Create app-->
                ...
                <span class="text-gray-400 fw-bold me-1"><?=APP_NAME?> © <?=date('Y')?> - Created by </span>
								<a href="https://rai.cr/" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">RAI</a>
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="<?=PATH_VIEW?>assets/media/avatars/150-11.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="<?=PATH_VIEW?>assets/media/avatars/150-3.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="<?=PATH_VIEW?>assets/media/avatars/150-5.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="<?=PATH_VIEW?>assets/media/avatars/150-2.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="<?=PATH_VIEW?>assets/media/avatars/150-6.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="<?=PATH_VIEW?>assets/media/svg/files/pdf.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="<?=PATH_VIEW?>assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="<?=PATH_VIEW?>assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-200px" src="<?=PATH_VIEW?>assets/media/demos/demo1.png" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-200px" src="<?=PATH_VIEW?>assets/media/demos/demo2.png" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-200px" src="<?=PATH_VIEW?>assets/media/demos/demo3.png" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="<?=PATH_VIEW?>assets/media/avatars/150-14.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-15.jpg" />
									</div>
									<!--end::Avatar-->
									<!--begin::Details-->
									<div class="ms-3">
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-2.jpg" />
									</div>
									<!--end::Avatar-->
								</div>
								<!--end::User-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="<?=PATH_VIEW?>assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
							...
							<div class="mh-300px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-1.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-4.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-8.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-6.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-7.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-17.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="<?=PATH_VIEW?>assets/media/avatars/150-10.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="<?=PATH_VIEW?>assets/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
														<img src="<?=PATH_VIEW?>assets/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
														<img src="<?=PATH_VIEW?>assets/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="<?=PATH_VIEW?>assets/media/illustrations/todo.png" alt="" class="mw-100 mh-150px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
    ...
    <?php _adminComponent('scripts'); ?>
    <?php _pageScriptAdmin(); ?>
