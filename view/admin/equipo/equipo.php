    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <label class="form-label">Nombre del nuevo equipo</label>
              <input type="text" class="form-control" id="f_nombre_equipo">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="btn_cancelar_equipo">Cancelar</button>
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" disabled id="btn_agregar_equipo"><i class="fas fa-plus"></i>Agregar nuevo equipo</button>
            </div>
        </div>
    </div>
</div>
